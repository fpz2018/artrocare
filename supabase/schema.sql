...
-- CLEAN INSTALL: drops existing objects first
-- =============================================
...
DROP INDEX IF EXISTS public.idx_profiles_therapist_email;
...
CREATE INDEX idx_profiles_therapist_email ON public.profiles(therapist_email) WHERE therapist_email IS NOT NULL;
...
('arthritis_basics', 'Wat is Artrose?', 'What is Arthritis?', 'Artrose is een aandoening waarbij het kraakbeen in je gewrichten slijt. Dit is een normaal proces dat bij veel mensen voorkomt, maar het hoeft geen zin te doen. Het kraakbeen in je gewrichten is als een kussen dat de botten beschermt. Bij artrose wordt dit kussen dunner, waardoor de botten dichter bij elkaar komen. Dit kan leiden tot pijn, stijfheid en verminderde beweeglijkheid. Maar het goede nieuws is: je kunt veel doen om je klachten te verminderen!', 'Osteoarthritis is a condition where the cartilage in your joints wears down. This is a normal process that occurs in many people, but it doesn''t have to be painful. The cartilage in your joints acts like a cushion protecting your bones. In osteoarthritis, this cushion becomes thinner, bringing bones closer together. This can lead to pain, stiffness and reduced mobility. But the good news is: there is a lot you can do to reduce your symptoms!', 'Leer de basis over artrose en waarom het niet het einde hoeft te zijn.', 'Learn the basics about osteoarthritis and why it doesn''t have to be the end.', ARRAY['Artrose is normaal en komt veel voor', 'Pijn betekent niet altijd schade', 'Beweging is de beste medicijn', 'Je kunt veel zelf doen'], ARRAY['Osteoarthritis is normal and common', 'Pain does not always mean damage', 'Exercise is the best medicine', 'There is a lot you can do yourself'], 'core', 1, 5, 'book'),
('movement_myth', 'Mythe: Rust is het Beste', 'Myth: Rest is Best', 'Een van de grootste misverstanden over artrose is dat je moet rusten. Het tegendeel is waar! Beweging is de allerbeste behandeling voor artrose. Wanneer je beweegt, produceren je gewrichten gewrichtsvloeistof die het kraakbeen voedt. Zonder beweging droogt het kraakbeen uit en wordt het kwetsbaarder. Denk aan je gewricht als een spons: je moet het samenpersen en loslaten om het gezond te houden.', 'One of the biggest misconceptions about osteoarthritis is that you should rest. The opposite is true! Exercise is the very best treatment for osteoarthritis. When you move, your joints produce synovial fluid that nourishes the cartilage. Without movement, the cartilage dries out and becomes more vulnerable. Think of your joint like a sponge: you need to compress and release it to keep it healthy.', 'Ontdek waarom bewegen beter is dan rusten bij artrose.', 'Discover why movement is better than rest for osteoarthritis.', ARRAY['Bewegen is beter dan rusten', 'Je gewrichten hebben beweging nodig', 'Begin rustig en bouw op', 'Pijn tijdens bewegen is normaal en niet gevaarlijk'], ARRAY['Movement is better than rest', 'Your joints need movement', 'Start slowly and build up', 'Pain during exercise is normal and not dangerous'], 'core', 2, 5, 'activity'),
('pain_science', 'Pijnwetenschap', 'Pain Science', 'Pijn is een alarmsignaal van je brein, maar het betekent niet altijd dat er schade is. Bij artrose kan je zenuwstelsel overgevoelig worden, waardoor je meer pijn voelt dan er daadwerkelijke schade is. Dit heet centrale sensitisatie. Door te begrijpen hoe pijn werkt, kun je er beter mee omgaan. Stress, slaapgebrek en angst kunnen allemaal pijn verergeren. Ontspanning, goede slaap en geleidelijk meer bewegen kunnen de pijn verminderen.', 'Pain is an alarm signal from your brain, but it does not always mean there is damage. In osteoarthritis, your nervous system can become oversensitive, causing you to feel more pain than the actual damage warrants. This is called central sensitization. By understanding how pain works, you can manage it better. Stress, lack of sleep and anxiety can all worsen pain. Relaxation, good sleep and gradually increasing activity can reduce pain.', 'Begrijp hoe pijn werkt en waarom meer pijn niet altijd meer schade betekent.', 'Understand how pain works and why more pain does not always mean more damage.', ARRAY['Pijn is niet altijd gelijk aan schade', 'Je brein kan pijn versterken', 'Stress en slaap beinvloeden pijn', 'Kennis over pijn vermindert pijn'], ARRAY['Pain does not always equal damage', 'Your brain can amplify pain', 'Stress and sleep affect pain', 'Knowledge about pain reduces pain'], 'core', 3, 5, 'brain');
