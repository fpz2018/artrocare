...
const nl = {
  ...
  disclaimer_text: 'Artrose Kompas biedt educatieve informatie en oefenprogramma\'s ter ondersteuning van mensen met artrose. Deze app vervangt geen medisch advies, diagnose of behandeling door een gekwalificeerde zorgverlener. Raadpleeg altijd je arts of fysiotherapeut voordat je begint met een nieuw oefenprogramma of je behandeling wijzigt.',
  disclaimer_short: 'Deze app vervangt geen medisch advies. Raadpleeg altijd je zorgverlener.',
  disclaimer_footer: 'Artrose Kompas is geen vervanging voor professioneel medisch advies.',
  disclaimer_exercise: 'Stop met oefenen als je ongewone pijn ervaart en raadpleeg je therapeut.',
  disclaimer_nutrition: 'Voedingsadvies is algemeen. Raadpleeg een dietist voor persoonlijk advies.',
  disclaimer_supplements: 'Raadpleeg altijd je arts voordat je supplementen gebruikt.',
  disclaimer_ai: 'AI-gegenereerde content is ter ondersteuning en vervangt geen professioneel advies.',
  disclaimer_medication: 'Wijzig nooit je medicatie zonder overleg met je arts.',
